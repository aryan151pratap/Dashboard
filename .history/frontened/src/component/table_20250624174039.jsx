function Table({ collection }){
	return(
		<>
		<table className="max-w-full table-auto border-collapse border border-gray-300 text-sm overflow-y-auto">
		<thead>
		...
		<tbody>
			...
			<tr key={rowIndex} className="even:bg-gray-50">
				...
				<td key={colIndex} className="border border-gray-300 px-4 py-2 break-all">
