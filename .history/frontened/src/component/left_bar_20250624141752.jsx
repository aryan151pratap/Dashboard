...
function Left_bar(){
	...
	return(
		<>
		<div className="shrink- h-fit sm:h-full w-full pt-12 sm:w-48 bg-zinc-200 sm:fixed left-0 top-0 border-b sm:border-r">

			<div className="flex flex-row">
				<button className="sm:text-center font-bold px-2 py-2 text-zinc-700">Database</button>
				{current_database &&
