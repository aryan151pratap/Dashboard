...
function Filter({ collection }){
	...
	const handle_search = function(){
		if (select.trim() ==='' || filter.trim() === '') setFilter_data(collection);
	...
	return(
		...
		<div className="w-full flex flex-col gap-2 p-2">
			...
			<div className="flex flex-col gap-4 p-2 bg-black text-green-500 overflow-x-auto">
				{filter_data.map((i, index) => (
					<pre
					className="boreder-b border-white"
