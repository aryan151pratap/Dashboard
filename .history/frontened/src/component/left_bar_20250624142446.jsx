	...
	return(
		...
		<div className="shrink-0 h-fit sm:h-full w-full pt-12 sm:w-48 bg-zinc-200 sm:fixed left-0 top-0 border-b sm:border-r">
			...
			<div className="flex flex-row">
				...
				{current_database &&
					<button className={`sm:text-center font-bold px-4 py-2 text-zinc-700 ${current_database !== null ? 'text-white bg-zinc-700' : 'text-zinc-700'}`}>{current_database.name}</button>
				}
			</div>
