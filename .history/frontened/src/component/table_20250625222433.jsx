...
function Table({ collection }) {
  ...
  const [rowHeight, setRowHeight] = useState("min-h-[100px] max-h-[200px]");
  ...
  return (
    <div className="w-full border-2 overflow-x-auto">
      <div className="flex items-center justify-between p-2 bg-gray-200 border-b-2">
        <div className="flex gap-4">
          ...
          <label className="text-sm">
            ...
            <select
              ...
              value={colWidth}
            >
              <option value="min-w-[100px] max-w-[250px]">Narrow</option>
                  ...
                  return (
                    ...
                    >
                      {typeof value === "object" ? (
                        ...
                        <p className={`${rowHeight} ${colWidth} whitespace-pre-wrap break-words overflow-auto`}> 
                         {String(value ?? "")}
                        </p>
                      )}
                    </td>
