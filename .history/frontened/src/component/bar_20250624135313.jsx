  ...
  return (
    <div>
		...
		<div className="h-screen flex sm:flex-col md:flex-col flex-row">
			<div className="h-fit sm:h-full w-full pt-12 sm:w-48 bg-zinc-200 absolute sm:fixed left-0 top-0 border-b sm:border-r">
				<p className="text-center font-bold p-2 text-zinc-700">Collections</p>
				<ul className="px-4 text-sm space-y-2 flex sm:flex-col flex-row gap-2">
