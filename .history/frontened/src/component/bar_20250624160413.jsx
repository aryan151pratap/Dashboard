		...
		<div className="w-full fixed top-0 left-0 flex justify-between items-center bg-zinc-800 text-white z-10">
			...
			<div className="h-full">
				{connected === 'connecting' ?
					...
					:
					<p className={`p-2 relative font-semibold text-sm ${connected !== 'not' ? "text-red-400 " : "text-red-400"}`}>
						<div className="absolute right-2 top-0  p-1 rounded-full bg-green-400">
						</div>
