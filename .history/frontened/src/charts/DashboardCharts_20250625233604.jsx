...
const DynamicChart = ({ data }) => {
  ...
  useEffect(() => {
    ...
    const sample = data.find((d) => typeof d === "object" && d !== null) || {};
    const keys = Object.keys(sample).filter((key) => typeof sample[key] === "number");
  ...
  const chartData = data
    .filter((item) => typeof item[selectedKey] === "number")
    .map((item, index) => ({
