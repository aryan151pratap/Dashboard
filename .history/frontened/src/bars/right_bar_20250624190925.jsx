			...
			{collection &&
				<div className="bg-zinc-200 p-2 mb-2">
					<div className="flex flex-row gap-2 overflow-x-auto font-semibold text-zinc-700">
						<span className="flex flex-row shrink-0 hover:underline cursor-pointer">
							<span className="">{collection.cluster}
								<span className="text-[10px]">(cluster)</span>
							</span>
