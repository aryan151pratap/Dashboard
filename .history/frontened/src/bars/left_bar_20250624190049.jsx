		...
		<div className="sticky top-0 shrink-0 h-fit sm:h-screen w-full sm:w-fit pt-12 bg-zinc-200 border-b sm:border-r">
			...
			<>	
				{current_database.collections?.map((i, index) => (
					<li key={index} className={`${current_collection === i ? 'bg-zinc-300 font-semibold' : ''} flex hover:underline cursor-pointer border-r sm:border-r-0 sm:border-b px-4 py-2`}
