function Right_bar({ collection }){
	return(
		<>
		<div className="shrink-0 w-full sm:pt-14 p-4">
			<div className="bg-zinc-200 p-2">
				{collection &&
				<div className="flex flex-row gap-2">
					<span className="hover:underline cursor-pointer">{collection.cluster}
					...
					<span className="hover:underline cursor-pointer">{collection.database}
						<svg xmlns="http://www.w3.org/2000/svg" className="w-4 h-4 ml-1 inline-block" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
							<path strokeLinecap="round" strokeLinejoin="round" d="M9 5l7 7-7 7" />
						</svg>
					</span>
					<span className="hover:underline cursor-pointer">{collection.collection}hjguygucvjghcvkujgkuhj
					</span>
				</div>
				}
			</div>
