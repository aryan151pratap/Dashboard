...
function Right_bar({ collection }){
	...
	return(
		<>
		<div className="relative w-full sm:pt-14 p-2 sm:p-4">
			<h1 className="text-xl font-bold mb-2 text-zinc-700">Dashboard Output</h1>
			
			{collection &&
				<div className="absolute bg-zinc-200 p-2 mb-2">
			...
			<div className="bg-white border rounded shadow text-sm text-zinc-800 overflow-hidden overflow-x-auto">
