...
function Connect({ setConnected, setShowModal, setCluster }){
	const [uri, setUri] = useState("");
	const mongoURIs = [
		{
			label: "Cluster 0",
			value: "mongodb+srv://apratapsingh151:nlu43vNExNlffaYA@cluster0.njxal.mongodb.net/"
		},
		{
			label: "Cluster 1",
			value: "mongodb://127.0.0.1:27017/project"
		}
	];
